...
export default function InteriorSection({ t, onOpenConsult }) {
  ...
  const portfolioProjects = [
    ...
    },
    {
      ...
      img: 'https://images.unsplash.com/photo-1541354329998-f4d9a9f9297f?auto=format&fit=crop&w=800&q=80',
  ...
  const styleOptions = [
    {
      id: 'luxury',
      name: 'Luxury Gold & Marble Finish',
      desc: '고급 대리석, Champagne Gold 포인트, 승강기 캐빈 파사드 일체형 디자인',
    ...
    {
      id: 'modern',
      name: 'Modern Glass Wall & Acoustic Steel',
      desc: 'KOICA/LG 오피스 적용 강화유리 파티션, 슬림 프레임 개방감, 인테리어 필름',
    ...
    {
      id: 'wood',
      name: 'Natural K-Wood & Cafe Lounge',
      desc: 'Shilla Hotel / Artisee Cafe 감성의 최고급 원목 질감과 편안한 K-디자인 감성',
      color: 'bg-gradient-to-r from-amber-800 to-yellow-700',
      bgImg: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80'
    }
  ];
